...
function up(){
    ...
    var total_living_area = document.getElementsByName("total_living_area")[0].value;
    var number_flats = document.getElementsByName("number_flats")[0].value;
    var living_area_except_ground_floor = document.getElementsByName("living_area_except_ground_floor")[0].value;
    var json = {
            "street":street, 
            "street_nr":street_nr,
            "post_code":post_code,
            ...
            "living_area_except_ground_floor":living_area_except_ground_floor,
